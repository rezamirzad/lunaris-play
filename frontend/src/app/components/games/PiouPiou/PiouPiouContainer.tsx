...
export default function PiouPiouContainer({
  ...
  const board = roomData.gameBoard.gameType === "pioupiou" ? roomData.gameBoard : null;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <AnimatePresence mode="popLayout">
                {roomData.players.map((player, index) => {
                  const playerState = player.state.gameType === "pioupiou" ? player.state : null;
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="bg-orange-500/10 text-orange-500 px-2 py-0.5 rounded border border-orange-500/20">LIVE</span>
            </div>
            
            <div className="space-y-3 text-zinc-500 border-t border-white/5 pt-6">
              <div className="flex justify-between items-center">
                <span className="uppercase tracking-widest">STATUS:</span>
                <span className="text-zinc-200 font-black uppercase tracking-tighter">{roomData.status}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-teal-400/50 font-black tracking-tighter">RSA_AES_256</span>
              </div>
            </div>
          </motion.section>
        </div>

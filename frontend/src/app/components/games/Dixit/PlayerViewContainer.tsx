 ...
 * Reuses the SharedPlayerController shell to maintain visual parity.
 */
export default function DixitPlayerView({
  ...
  // LOGIC: Check if the player is the Storyteller for this turn[cite: 1]

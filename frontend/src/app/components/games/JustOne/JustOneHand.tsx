...
export default function JustOneHand({
  ...
  const localizedMysteryWord =
    mysteryWordObj[initialLang] || mysteryWordObj["en"];
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onPointerDown={(e) => {
                      if (e.pointerType === "touch") handleGuessSubmit(false);
                    }}
                    onClick={(e) => {
                      if ((e as any).pointerType !== "touch")
                        handleGuessSubmit(false);
                    }}
              ...
              {hasSubmittedClue ? (
                ...
                <>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onPointerDown={(e) => {
                      if (e.pointerType === "touch") handleClueSubmit();
                    }}
                    onClick={(e) => {
                      if ((e as any).pointerType !== "touch")
                        handleClueSubmit();
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 z-[100]">
                <motion.button
                  ...
                  onPointerDown={(e) => {
                    if (!hasConfirmedValidation && e.pointerType === "touch")
